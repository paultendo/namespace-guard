...
// Source: confusable-vision ${path.basename(jsonPath)} (${data.meta.pairCount} pairs${data.meta.release ? `, release ${data.meta.release}` : ""})
...
/**
 * Measured visual similarity weights for ${data.meta.pairCount} confusable pairs${data.meta.release
